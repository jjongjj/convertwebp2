...
1. 프로젝트 폴더의 `start-convertwemp.command` 파일을 더블클릭
2. GUI 창이 열리면 GIF 파일을 드래그 앤 드롭하거나 "파일 선택" 버튼 클릭
3. 설정 패널에서 품질/압축 옵션 조정 (또는 프리셋 버튼 사용)
4. "▶️ 변환 시작" 버튼을 클릭하여 변환 실행
5. 완료 후 "📁 결과 폴더 열기"로 변환된 파일 확인
